...
async function getAiResponse(chatBot, chat, chatRequest, userInfo) {
    ...
    if (chatRequest.image) {
        ...
        let imageDescription = imageResponse.data.choices[0].message.content;
        userText = `Briefly explain about ${imageDescription} and then answer ${userText}. Dont mention anything about image description.`;
